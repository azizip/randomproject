<?php session_start(); include '../../config/page.php'; include 'auth.php';  include '../../config/conn.php'; ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="wrapper">
    	...
    	<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
				...
				<div class="sidebar-brand-text mx-3"><img src="../../assets/img/logo1.jpg" width="43%"></div>
			</a>
		    ...
		    <li class="nav-item <?php if (isset($menu2A)) echo $menu2A ?>">
		        <a class="nav-link" href="report.php?page=2A">
			        ...
			        <ul class="navbar-nav ml-auto">
			            ...
			            <li class="nav-item dropdown no-arrow">
				            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				            	<span class="mr-2 d-none d-lg-inline text-gray-600 small"><i class="fas fa-user fa-sm fa-fw mr-2"></i><?=$_SESSION["name"]?></span>
				            </a>
			            </li>
